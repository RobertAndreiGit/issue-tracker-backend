package all.request_handler.response_entities.utils;
...
public class Messages
{
    ...
    public static final String STAGE_DOES_NOT_EXIST="The stage does not exist.";
    public static final String CATEGORY_DOES_NOT_EXIST="The category does not exist.";
    public static final String PRIORITY_DOES_NOT_EXIST="The priority does not exist.";
    public static final String BOARD_DOES_NOT_EXIST="The board does not exist.";
    public static final String USERNAME_EXISTS="The username already exist.";
